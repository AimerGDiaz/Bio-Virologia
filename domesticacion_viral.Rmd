...
## ¿Qué papel juega el virus de la hepatitis B en la vacuna contra la malaria "RTS,S"? {#malariaVaccine}
...
![Morfología por cada etapa del ciclo de vida de 4 especies de Plasmodium](figures/plasmodium.png){ width=20% }
...
![Ciclo de vida de *Plasmodium falciparum*](figures/Plasmodium_sp.jpg){ width=20% }
