...
El Blog en Facebook [Biovirología](https://www.facebook.com/BioViral/) ha sido re-lanzado bajo el formato  nada tradicional de libros electrónicos: Bookdown, un formato web con las características de los libros electrónicos más todas las posibilidades de edición y de contendio de un sitio web. Por lo que en este formato se puede escribir, editar y hasta interactuar con los lectores, además de insertar códigos escritos en los lenguajes de programación R, bash, perl, python (entre otros), o emplear, incluso, comandos del lenguaje estructurado TeX (con el que se generan documentos LaTex). Funcionando,  por tanto, como un block de notas, en el que se puede visulizar el output o la salida de los códigos en él escritos. Así, con esta transición, BioVirología se convierte en el primer blog de divulgación científica en español en hacerse libro electrónico interactivo, además del primer bookdown de virología biológica o biovirología.
